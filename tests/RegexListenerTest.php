...
class RegexListenerTest extends TestCase {
     ...
     */
    public function testReadFirstAndLast ()    {
     ...
     */
    public function testBasicReadArray ()    {
        $filename = __DIR__.'/data/example.json';
        $testJSON = json_decode(file_get_contents($filename), true);
     ...
     */
    public function testBasicReadArrayElement ()    {
     ...
     */
    public function testBasicReadArrayObjects ()    {
        $filename = __DIR__.'/data/example.json';
        $testJSON = json_decode(file_get_contents($filename), true);
     ...
     */
    public function testBasicReadArrayIDs ()    {
     ...
     */
    public function testBasicReadStop ()    {
        $filename = __DIR__.'/data/example.json';
        $testJSON = json_decode(file_get_contents($filename), true);
        ...
        $listener->setMatch(["/0/name" => $arrayCall,
            "/0/integer" => function($data) use ($parser) {
                $parser->stop();
            },
     ...
     */
    public function testBasicArrayRead ()    {
     ...
     */
    public function testBasicArrayReadCapture ()    {
        $filename = __DIR__.'/data/simpleArray.json';
